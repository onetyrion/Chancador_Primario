...
export default function DetencionesChancadores(props) {
  ...
  const setDatos = async (hidden) => {
    ...
    setColumns([
      ...
      {
        title: "Hrs.Prog",
        field: "Horas_programadas",
        hidden: hiddenColumn,
        editComponent: customInput,
      },
      {
        title: "Hrs.No Prog",
        field: "Horas_no_programadas",
        hidden: hiddenColumn,
        editComponent: customInput,
      },
      {
        title: "Ev.Prog",
        field: "Cantidad_evProgramados",
        hidden: hiddenColumn,
        editComponent: customInput,
      },
      {
        title: "Ev.No Prog",
        field: "Cantidad_evNoProgramados",
        hidden: hiddenColumn,
        editComponent: customInput,
      },
      {
  ...
  const rowAdd = (newData) =>
    new Promise((resolve, reject) => {
      setTimeout(() => {
        CreateMantencionAPI(newData).then((value) => {
          if (value.errors) {
            notify.show(
              `Ha ocurrido un error, revise los datos`,
              "error",
              5000
            );
          } else {
      ...
      <Card>
        <CardHeader color="primary">
          <h4 className={classes.cardTitleWhite}>
            Registrar Detenciones del Chancador Priamario
          </h4>
        </CardHeader>
        <form
            ...
            <GridContainer>
              ...
              <GridItem xs={12} sm={12} md={3}>
                <CustomInput
                  ...
                  inputProps={{
                    value: Cantidad_evNoProgramados
                      ? Cantidad_evNoProgramados
                      : 0,
                    type: "number",
                    onChange: (e) =>
                      SetCantidad_evNoProgramados(e.target.value),
                    required: true,
                  }}
                />
              </GridItem>
                ...
                >
                  ...
                  >
                    {Object.entries(listipo).map((values, index) => (
                      <MenuItem value={values[0]} key={index}>
                        {values[1]}
                      </MenuItem>
                    ))}
                  </Select>
              ...
              <GridItem xs={12} sm={12} md={6}>
                <FormControl
                  ...
                  style={{ marginTop: "27px" }}
                >
                  <InputLabel id="select-componente-historic">
                    Componente
                  </InputLabel>
                  <Select
      ...
      <GridContainer>
        <GridItem xs={12} sm={12} md={12}>
          <Card>
            <CardHeader color="primary">
              <h4 className={classes.cardTitleWhite}>
                Registro de detenciones de los Chancadores
              </h4>
            </CardHeader>
            <CardBody>
              <MaterialTable
                ...
                options={{
                  ...
                  exportDelimiter: ";",
                  exportFileName:
                    "REG_DETENCIONES_" + new Date().toLocaleString(),
            ...
            <CardFooter className={classes.CardFooterBox}>
              <Divider light />
              <Button color="primary" onClick={() => handleModal(null, "add")}>
                Añadir Meta
              </Button>
            </CardFooter>
          </Card>
